...
const SERIES = [
  ...
  {
    id: 3,
    title: "Prophets of the Old Testament",
    count: 10,
      ...
      <div className="space-y-5 pb-4">
        ...
        >
          <div className="mb-1 flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-indigo-500/20 bg-indigo-600/20">
          ...
          >
            3,200+ messages from the Word of God
          </p>
        </motion.div>
          ...
          {FILTERS.map((f) => {
            ...
            return (
              <button
                ...
                className={`shrink-0 rounded-full border px-3.5 py-1.5 text-[11px] font-black transition-all ${
                  isActive
                    ? "border-transparent bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-lg shadow-indigo-500/20"
                    : ""
                }`}
                style={
                  !isActive
          ...
          >
            {SERIES.map((s, i) => (
              <motion.div
                ...
                className={`w-64 shrink-0 rounded-2xl bg-gradient-to-br ${s.gradient} p-4 shadow-md`}
              >
                ...
                <h3 className="mb-1 text-[15px] font-black text-white">
                  {s.title}
                </h3>
                <p className="mb-2 line-clamp-2 text-[11px] leading-relaxed font-medium text-white/70">
                  {s.desc}
                </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-1 flex items-center gap-1.5">
                    <button
                      onClick={toggleLike}
                      className={`rounded-lg p-1.5 transition-colors ${isLiked ? "text-red-400" : "text-slate-600 hover:text-white"}`}
                    >
                      <Heart
                        size={13}
                    ...
                    <button
                      onClick={toggleSave}
                      className={`rounded-lg p-1.5 transition-colors ${isSaved ? "text-cyan-400" : "text-slate-600 hover:text-cyan-400"}`}
                    >
                      <Bookmark
                        size={13}
                    ...
                    <button className="rounded-lg p-1.5 text-slate-600 transition-colors hover:text-cyan-400">
                      <Play size={13} />
                    </button>
                    <button className="rounded-lg p-1.5 text-slate-600 transition-colors hover:text-white">
                      <Share2 size={13} />
                    </button>
                  </div>
                </motion.div>
