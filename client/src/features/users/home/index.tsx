...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6 pb-28 md:pb-10">
      ...
      >
        <p className="text-[11px] font-black tracking-widest text-cyan-400 uppercase mb-0.5">
          ✝ Welcome
        </p>
      ...
      >
        <Link to="/jesus-is-lord-radio">
          <motion.div
            ...
            whileTap={{ scale: 0.97 }}
            className="relative flex items-center justify-between overflow-hidden rounded-2xl border border-white/8 px-5 py-4"
          ...
          >
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">95.3 · 105.9 FM</p>
              </div>
            </div>

            <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 shadow-lg shadow-blue-500/30">
            ...
            >
              <Link to={a.to}>
                <motion.div
                  ...
                  whileTap={{ scale: 0.94 }}
                  className="relative flex flex-col items-center justify-center gap-2.5 rounded-2xl border border-white/5 bg-white/3 py-5 text-center"
                >
                  {a.live && (
